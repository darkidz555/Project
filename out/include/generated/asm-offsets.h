...
#define TSK_ACTIVE_MM 952 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_TI_TTBR0 16 /* offsetof(struct thread_info, ttbr0) */

#define THREAD_CPU_CONTEXT 2224 /* offsetof(struct task_struct, thread.cpu_context) */
