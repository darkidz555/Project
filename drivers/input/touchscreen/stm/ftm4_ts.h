...
#define STATUS_EVENT_FORCE_CALIBRATION			0x05
...
#define STATUS_EVENT_VR_MODE_ENABLED			0xE1
#define STATUS_EVENT_VR_MODE_DISABLED			0xE2
#define STATUS_EVENT_REBOOT_BY_ESD			0xED
