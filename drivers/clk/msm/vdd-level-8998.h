...
enum vdd_dig_levels {
	...
	VDD_DIG_LOWER,		/* SVS2 */
	VDD_DIG_LOW,		/* SVS */
	VDD_DIG_LOW_L1,		/* TURBO */
	VDD_DIG_NOMINAL,	/* TURBO */
	VDD_DIG_HIGH,		/* TURBO */
	VDD_DIG_NUM
};
...
static int vdd_corner[] = {
	...
	RPM_REGULATOR_LEVEL_SVS,		/* VDD_DIG_HIGH */
	RPM_REGULATOR_LEVEL_SVS_PLUS,		/* VDD_DIG_HIGH */
	RPM_REGULATOR_LEVEL_NOM,		/* VDD_DIG_HIGH */
